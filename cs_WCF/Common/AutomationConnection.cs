        ...
        public static ISqlMapper EntityMapper {
            get {
                try
                {
                    ...
                    XmlDocument sqlMapConfig = Resources.GetEmbeddedResourceAsXmlDocument("Config.SqlMap.AutomationSqlMap.config, cs_WCF");
                    ...
                    mapper.DataSource.ConnectionString = string.Format(@"Server=(localdb)\MSSQLLocalDB; Integrated Security=true ;AttachDbFileName={0};", AppDomain.CurrentDomain.BaseDirectory + "LocalDB\\AutomationDB.mdf");
                    return mapper;
                }
                catch (Exception ex)
                {
